    ...
    <section id="blogs" className="relative bg-white px-5 py-24 sm:px-10">
      <div className="mx-auto max-w-[1600px]">
        ...
        <div className="mb-20 flex flex-col items-center text-center">
          <motion.div
            ...
            viewport={{ once: true }}
            className="mb-4 inline-flex items-center gap-2 rounded-full bg-[#FAF5F5] px-4 py-1.5 text-[10px] font-bold uppercase tracking-[0.2em] text-[#17171F]"
          >
            <span className="h-1.5 w-1.5 rounded-full bg-[#F0453D]" />
            Blogs
          </motion.div>
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-4xl font-extrabold text-[#111118] sm:text-6xl"
          >
        ...
        <div className="grid grid-cols-1 gap-y-24 lg:grid-cols-2 lg:gap-x-12 pb-16">
            ...
            >
              ...
              <div className="relative aspect-[16/10] w-full overflow-hidden rounded-[2.5rem] bg-gray-100 shadow-lg">
                ...
                <div className="absolute left-8 top-8 z-20 flex h-20 w-20 items-center justify-center rounded-[1.5rem] bg-white shadow-xl transition-transform duration-300 group-hover:-translate-y-1 group-hover:scale-105">
                  <span className="text-4xl font-black text-[#111118]">
                    {post.day}
                  </span>
                </div>
              </div>
              ...
              <motion.div
                ...
                className="absolute -bottom-12 left-8 right-8 z-30 cursor-pointer overflow-hidden rounded-[2.5rem] bg-[#1a1a1a]/85 p-8 shadow-2xl backdrop-blur-xl border border-white/5 transition-all duration-300 group-hover:bg-[#1a1a1a]/95"
              >
                {/* Meta Info */}
                <div className="mb-4 flex flex-wrap gap-4 text-[10px] font-bold uppercase tracking-widest">
                  <span className="flex items-center gap-1.5 text-[#F0453D]">
                ...
                <div className="flex items-center justify-between border-t border-white/10 pt-6">
                  ...
                  <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#F0453D] text-white shadow-lg transition-all duration-300 group-hover:rotate-45 group-hover:scale-110">
      ...
      >
        <div className="flex flex-col gap-6">
          ...
          <button className="w-full rounded-full bg-[#F0453D] py-4 font-bold text-white shadow-xl transition-all hover:brightness-110">
